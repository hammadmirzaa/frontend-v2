...
import { Send, Mic, MicOff, Phone, PhoneOff, Settings } from 'lucide-react'
...
export default function ChatbotTab() {
  ...
  const [messages, setMessages] = useState([
    { role: 'assistant', content: 'Hello! How can I help you today? Upload some documents to get started.' }
  ])
  ...
  const {
    ...
    stopSpeaking,
    setTranscript,
  } = useVoice({ useDefault: false }) // ChatbotTab uses context-specific voice
  ...
  const handleVoiceSelect = (voice) => {
    ...
    showToast(`Voice "${voice.name}" selected for Chat Assistant`, 'success')
    return true
  }
  ...
  // Reset session when component unmounts (chatbot closed)
  useEffect(() => {
    return () => {
      ...
      <div className="p-6 border-b">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Ask questions about your uploaded documents</p>
          </div>
